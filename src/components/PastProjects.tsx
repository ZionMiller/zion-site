      ...
      <Card.Group centered marginTop="10px">
        <Card style={{ backgroundColor: "#e8eed8" }}>
          <Card.Content>
            ...
            <Card.Description>
              <strong>Description</strong>: BioBreak helps biotech investors
              save time with novel data visualizations containing KPIs buried
              deep in SEC filings, clinical trials, and more. What used to take
              countless tabs and hours of careful reading can now be done at the
              click of a button.
            </Card.Description>
            <Card.Description>
              <br></br>
              <strong>Role</strong>: Sole developer (React Frontend, Rails
              Backend)
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
        ...
        <Card style={{ backgroundColor: "#e8eed8" }}>
          <Card.Content>
            ...
            <Card.Description>
              <strong>Description</strong>: Flight Finder ranks the cheapest
              flights to the desired destination based on surrounding airports
              in a specified circumference
            </Card.Description>
            <br></br>
            <Card.Description>
        ...
        <Card style={{ backgroundColor: "#e8eed8" }}>
          <Card.Content>
            ...
            <Card.Description>
              <strong>Description</strong>: A project built in a week to emulate
              Hearthstone basic gameplay with unlikely combatants such as a baby
              versus the IRS. The project was built using React and Rails
            </Card.Description>
            <br></br>
            <Card.Description>
        ...
        <Card style={{ backgroundColor: "#e8eed8" }}>
          <Card.Content>
            ...
            <Card.Description>
              <strong>Description</strong>: One-stop shop for snippets and
              shortcuts
            </Card.Description>
            <Card.Description>
        ...
        <Card style={{ backgroundColor: "#e8eed8" }}>
          <Card.Content>
            <Image
              ...
              size="medium"
              src={
                "https://i.ibb.co/Wfn9rHr/tumblr-mfoibvy2v41rfjowdo1-500.gif"
              }
            />
            <Card.Meta>Ghibli Film Reviews</Card.Meta>
            <Card.Description>
              <strong>Description</strong>: Consolidated details and reviews on
              all things Studio Ghibli
            </Card.Description>
            <Card.Description>
              <br></br>
        ...
        <Card style={{ backgroundColor: "#e8eed8" }}>
          <Card.Content>
            ...
            <Card.Description>
              <strong>Description</strong>: Flashcard app designed to help
              myself and fellow Flatiron students study our first phase of
              JavaScript
            </Card.Description>
            <Card.Description>
              <br></br>
