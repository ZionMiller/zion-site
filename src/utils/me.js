const profileData = {
  name: "Andrew Almeida",
  bio: "My coding journey has been arduous to say the least! My career started in optical production at Costco Wholesale. I spend over a decade with Costco, all of my twenties. There, I cultivated the qualities that make me not only a great employee, but a great teammate. I learned not only to work under high pressure, but to do so with grace and calm. \n\n
